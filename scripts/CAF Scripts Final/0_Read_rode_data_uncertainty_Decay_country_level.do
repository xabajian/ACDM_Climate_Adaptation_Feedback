...
merge m:1 ISO3 using "$processed/country_level_trends.dta",
...
//save proper panel 
save "$processed/country_year_scenario_panel_9_12_decay_country_level.dta", replace
...
use "$processed/country_year_scenario_panel_9_12_decay_country_level.dta", clear
...
save "$processed/aggregate_adaptation_9_12_decay_country_level.dta", replace
