...
library(haven)
country_year_emissions_factor <- read_dta("country_year_emissions_factor_2010s.dta")
...
mapParams <- mapCountryData(sPDF
                            ,nameColumnToPlot="mean_2010s_electric"
                            #,nameColumnToPlot="mean_2010s_electric mean_2010s_otherfuels"
                            ,addLegend=FALSE
                            ,catMethod = catMethod
                            ,colourPalette=colourPalette
                            #,mapTitle = "Average Other Fuels Emissions Factor 2010-18")
                            ,mapTitle = "Average Electricity Emissions Factor 2010-18")
#adding legend
